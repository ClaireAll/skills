...
description: Use when a requirement or decision has unresolved facts held by a specific stakeholder and the user asks to produce a questionnaire for that person to answer.
---
